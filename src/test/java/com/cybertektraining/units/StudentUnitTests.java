...
public class StudentUnitTests {
    ...
    @Test
    public void test2() {
        //burda direct pojo lari kullanarak addstudent yaptik
        ...
        Student student = new Student("123456", 11, "01/06/1990", company, contact,
                "Hacer", "Male", "11/26/2017",
                "Khan", "MBA", "AP-45", "1111", "Math");
    ...
    @Test
    public void test3() {
        //burda da pojolar json file i active ediyor ve biz de json file i kullanarak addstudent yaptik
